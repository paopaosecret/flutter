package com.example.flutterstudy.floatwindow;
...
public class FloatWindowService extends Service {
    ...
    private static ImageView mCallView;
    ...
    public static void startFloatService(Context context, ImageView callView) {
        mContext = context;
        mCallView = callView;
    ...
    private void initWindow() {
        ...
        if (null != mCallView) {
            mCallView.setBackgroundResource(R.drawable.icon_call);
