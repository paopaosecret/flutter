...
import 'package:flutterstudy/widget/proxy_header_widget.dart';
...
/// 创建没有更多视图
typedef NoMoreBuilder = Widget Function(BuildContext context);

/// 滑动事件回调,当前滑动距离
typedef ScrollNotify = void Function(double scrollPixel);
