...
import 'package:flutterstudy/page/timing_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      child: Column(
        ...
        ///主轴方向对齐方式，Column主轴为垂直方向，ROW主轴为水平方向
        crossAxisAlignment: CrossAxisAlignment.start,

        ///纵轴方向对齐方式，Column纵轴为水平方向，ROW纵轴为垂直方向
        mainAxisSize: MainAxisSize.max, //主轴方向尺寸
        children: <Widget>[
          Container(
            child: Text(
                "文本框组件纵轴方向对齐方式，Column纵轴为水平方向，ROW纵轴为垂直方向纵轴方向对齐方式，Column纵轴为水平方向，ROW纵轴为垂直方向",
                softWrap: true,
...
//                  overflow: TextOverflow.ellipsis,
                style: TextStyle(
                    ...
                    ///线条样式 画一条直线 solid,  画两条线double,画圆点虚线dotted, 画破折号虚线dashed, 画波浪线wavy
                    )),
          ),
          Container(
            ///测试：ListView
            ...
            child: ListView(
              ...
              children: <Widget>[
                ...
                ElevatedButton(
                    onPressed: () {
                      if (isStartTimer) {
                        TimingWidget.stopTimer();
                      } else {
                        TimingWidget.startTimer();
                      }
...
//                        borderRadius: BorderRadius.circular(10),
                    ...
                    gradient: LinearGradient(
                      //设置渐变 RadialGradient:环形渐变，从里到外   LinearGradient线性渐变：可以设置beagin
                      colors: [
                        Color(0xFFFF99FF),
                        Color(0xFFFF33FF),
                      ],
          ...
          Container(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (BuildContext context, int index) {
                return Text(
                    'Index${index}Domestic life was never quite my styleDomestic life was never quite my styleDomestic life was never quite my style',
                    softWrap: true,
//                        overflow: TextOverflow.ellipsis,
                    style: TextStyle(
                      color: Colors.redAccent,
